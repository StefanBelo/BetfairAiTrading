...
1. [x] Retrieve active market and selections using GetActiveBetfairMarket (SILENT)
2. [x] Retrieve all three data contexts for the active market (SILENT)
3. [x] Calculate semantic form scores for all runners from race descriptions (SILENT)
4. [x] Calculate composite scores for all runners (SILENT)
5. [x] Calculate Expected Value for all runners (SILENT)
6. [x] Identify highest scoring selection above semantic form, composite score and EV thresholds (SILENT)
7. [x] Validate selection meets all criteria (SILENT)
8. [x] Confirm adequate market liquidity (SILENT)
...
**Financial Risk Warning**: This strategy involves real money betting. Past performance does not guarantee future results.

**Responsible Gambling**: Only bet amounts you can afford to lose. Set daily/weekly limits.

**Strategy Limitations**: No betting strategy can guarantee profits. Market conditions can change rapidly.
