...
**Expected Value (EV)**, on the other hand, measures the average profit or loss you can expect per unit staked, taking into account both your probability and the odds offered. The formula is:
$$
EV = p_{true} \times (\text{price} - 1) - (1 - p_{true})
$$
