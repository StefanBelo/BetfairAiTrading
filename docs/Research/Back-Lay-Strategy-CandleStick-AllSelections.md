...
Use correlation analysis to better predict price movement for the best selection. Recommend the best trade direction (back or lay), entry odds, and indicate if the horse is expected to win or lose.
