---
title: "Horse Racing Win Probability Analysis with Favourite Value Assessment"
aliases: ["Horse Racing Win Probability Analysis with Favourite Value Assessment"]
type: research
