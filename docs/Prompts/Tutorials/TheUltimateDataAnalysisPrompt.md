...
- For text data, perform a semantic analysis of the content
...
Now, retrieve the active Betfair market using `GetActiveBetfairMarket` and the context data `RacingpostDataForHorsesInfo` for this market using `GetDataContextForBetfairMarket`, then analyze as described in the prompt.
