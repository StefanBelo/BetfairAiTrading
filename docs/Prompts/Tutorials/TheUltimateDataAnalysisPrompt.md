...
Now, retrieve the active Betfair market using `GetActiveMarket` and the context data `RacingpostDataForHorses` for this market using `GetAllDataContextForMarket`, then analyze as described in the prompt.
