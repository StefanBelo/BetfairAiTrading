---
title: "Trading Chart Creation Prompt"
aliases: ["Trading Chart Creation Prompt"]
type: prompt
tags: [automation, bfexplorer, horse-racing, mcp, prompt, trading]
...
- `GetAllDataContextForMarket("MarketSelectionsPriceHistoryData", marketId)`
