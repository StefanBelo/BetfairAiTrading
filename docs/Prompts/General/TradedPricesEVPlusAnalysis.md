---
title: "Automated Traded Prices EV Analysis Prompt"
aliases: ["Automated Traded Prices EV Analysis Prompt"]
type: prompt
tags: [automation, bfexplorer, ev-analysis, horse-racing, market-sentiment, mcp, prompt, staking, trading]
...
2. **AUTOMATICALLY** retrieve trading data using: `GetAllDataContextForMarket` with dataContextNames ["MarketSelectionsTradedPricesData", "RacingpostDataForHorses"]
