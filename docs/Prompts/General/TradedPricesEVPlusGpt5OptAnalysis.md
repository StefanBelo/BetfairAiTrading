---
title: "Tradedpricesevplusgpt5Optanalysis"
aliases: ["Tradedpricesevplusgpt5Optanalysis"]
type: research
tags: [automation, ev-analysis, horse-racing, market-sentiment, research, staking, trading]
...
2. **Obtain Trading Data:**
   - Use `GetAllDataContextForMarket` with `dataContextNames`: `["MarketSelectionsTradedPricesData", "RacingpostDataForHorses"]` and the marketId from Step 1.
