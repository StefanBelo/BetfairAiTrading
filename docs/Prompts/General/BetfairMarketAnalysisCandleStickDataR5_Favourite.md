---
title: "Favourite Bet Decision Prompt (Compact)"
aliases: ["Favourite Bet Decision Prompt (Compact)"]
type: prompt
tags: [automation, bfexplorer, prompt]
...
2. Candles & BLR: GetAllDataContextForMarket("MarketSelectionsCandleStickData")
