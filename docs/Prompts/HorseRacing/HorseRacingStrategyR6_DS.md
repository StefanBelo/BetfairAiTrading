---
title: "Horse Racing Strategy R6 - Direct Signal"
aliases: ["Horse Racing Strategy R6 - Direct Signal"]
type: strategy
...
2.  Retrieve the three required data contexts `GetAllDataContextForMarket`.
