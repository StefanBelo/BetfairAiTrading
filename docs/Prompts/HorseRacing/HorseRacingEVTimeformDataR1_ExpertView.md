---
title: "Horse Racing EV Analysis - Timeform Data"
aliases: ["Horse Racing EV Analysis - Timeform Data"]
type: research
...
2. **Get Horse Data**: Use `GetAllDataContextForMarket` with `dataContextName: "TimeformFullDataForHorses"`
