---
title: "Horse Racing Bookmakers Odds Analysis - Favourite Value Strategy"
aliases: ["Horse Racing Bookmakers Odds Analysis - Favourite Value Strategy"]
type: strategy
tags: [bfexplorer, horse-racing, silent-execution, strategy]
mcp_tools: [GetActiveMarket, GetAllDataContextForMarket]
data_contexts: [AtTheRacesBookmakersOdds]
---
...
2. **Get Horse Data**: Use `GetAllDataContextForMarket` with `dataContextName: "AtTheRacesBookmakersOdds"`
