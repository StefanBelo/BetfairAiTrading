---
title: "Horse Racing Analysis — Timeform Expert View (Research Mode)"
aliases: ["Horse Racing Analysis — Timeform Expert View (Research Mode)"]
type: research
tags: [automation, ev-analysis, horse-racing, market-sentiment, research]
mcp_tools: [GetActiveMarket, GetAllDataContextForMarket]
data_contexts: [HorseRacingEVTimeformAnalysis, TimeformFullDataForHorses]
---
...
- Call `GetAllDataContextForMarket` with `dataContextName = "TimeformFullDataForHorses"`.
