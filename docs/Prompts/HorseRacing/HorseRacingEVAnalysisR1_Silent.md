---
title: "Horse Racing EV Analysis R1 (Silent)"
aliases: ["Horse Racing EV Analysis R1 (Silent)"]
type: research
tags: [bfexplorer, ev-analysis, horse-racing, market-sentiment, research, silent-execution]
...
### 2. Fetch Horse Data
- Call `GetAllDataContextForMarket` with `dataContextNames: ['RacingpostDataForHorses']` to retrieve detailed horse performance data.
