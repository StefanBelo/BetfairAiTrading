---
title: "Horse Racing EV Analysis - AtTheRaces Data - the first horse that fulfills the Sentiment Score Thresholds for BACK"
aliases: ["Horse Racing EV Analysis - AtTheRaces Data - the first horse that fulfills the Sentiment Score Thresholds for BACK"]
type: research
tags: [bfexplorer, ev-analysis, horse-racing, market-sentiment, research, silent-execution, trading]
...
2. **Get Horse Data**: Use `GetAllDataContextForMarket` with `dataContextName: "AtTheRacesDataForHorses"`
