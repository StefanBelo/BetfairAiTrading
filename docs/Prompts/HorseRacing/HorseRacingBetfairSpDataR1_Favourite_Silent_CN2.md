---
title: "赛马：热门（BSP）— 静默模式"
aliases: ["赛马：热门（BSP）— 静默模式"]
type: note
tags: [bfexplorer, note]
---
...
- Action: [Back 10 EUR/Lay 10 EUR]
- selectionId: [id]
- Reason: [BACK criteria/ LAY criteria/ No data]
- BSP Metrics: priceRatio=[x.xx], bspEdge=[x.xxxx], bspEvNet=[x.xxxx]
