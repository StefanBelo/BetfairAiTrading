---
title: "Horse Racing Expected Value Analysis with Dutch Betting (OLBG Tips Data)"
aliases: ["Horse Racing Expected Value Analysis with Dutch Betting (OLBG Tips Data)"]
type: research
tags: [automation, bfexplorer, ev-analysis, horse-racing, mcp, research, silent-execution]
...
- `GetAllDataContextForMarket`: To retrieve OLBG tips data (use dataContextName: "OlbgRaceTipsData").
...
- Retrieve `OlbgRaceTipsData` data context for the market using `GetAllDataContextForMarket`
