---
title: "Horse Racing Strategy R5.3 - Enhanced Multi-Context Analysis with Weight of Money Integration"
aliases: ["Horse Racing Strategy R5.3 - Enhanced Multi-Context Analysis with Weight of Money Integration"]
type: strategy
tags: [automation, bfexplorer, ev-analysis, horse-racing, market-sentiment, strategy, trading]
mcp_tools: [GetActiveMarket, GetAllDataContextForMarket]
data_contexts: [HorseRacingR5_1_Analysis, MarketSelectionsTradedPricesData, RacingpostDataForHorses, WeightOfMoneyData]
---
...
**CRITICAL REQUIREMENT**: ALL analyses must utilize GetAllDataContextForMarket with all four data contexts including "WeightOfMoneyData" and store results using SetAIAgentDataContextForBetfairMarket with dataContextName "HorseRacingR5_1_Analysis" for comprehensive multi-source model tracking and validation.
...
```json
{
  "analysisMetadata": {
    ...
    "fieldSize": 8,
    "dataSourcesUsed": ["RacingpostDataForHorses", "HorsesBaseBetfairFormData", "MarketSelectionsTradedPricesData", "WeightOfMoneyData"],
