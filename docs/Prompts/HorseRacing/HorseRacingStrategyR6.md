---
title: "Horse Racing Strategy R6 - Optimized"
aliases: ["Horse Racing Strategy R6 - Optimized"]
type: strategy
...
2.  Retrieve the three required data contexts using `GetAllDataContextForMarket`.
