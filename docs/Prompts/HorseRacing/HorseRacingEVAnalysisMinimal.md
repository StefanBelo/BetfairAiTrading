---
title: "Horse Racing EV Analysis - Minimal Execution Only"
aliases: ["Horse Racing EV Analysis - Minimal Execution Only"]
type: research
tags: [bfexplorer, ev-analysis, horse-racing, research, silent-execution]
...
2. **Silent Performance Data Collection**
   - Retrieve data context 'RacingpostDataForHorses' using tool: GetAllDataContextForMarket
